...
const coverUrl: string = 'https://images.unsplash.com/photo-1612962280801-05d09bb6244c?q=80&w=3864&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'

export default function LoginPage() {
  return (
    <div className='w-screen h-screen flex items-center bg-white md:bg-[#222831ef] '>
      <Image src={coverUrl} alt="logo"
        width={600} height={600} className='hidden md:block md:fixed w-screen h-screen object-cover -z-10' />
