      ...
      <div>
        <div className="container mx-auto">
          ...
          <div className="w-96 h-96 my-12 mx-auto p-8 flex flex-col gap-2 shadow">
            ...
            <Link href='/signup/newAdmin' className="text-sm text-center leading-5 w-full py-2 px-3 text-white bg-indigo-500 rounded-lg shadow-sm hover:shadow-lg transition-all">创建管理员账户</Link>
          </div>
        </div>
      </div>
    )
